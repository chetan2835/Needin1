...
const testimonials = [
  ...
  location: "Jaipur",
  rating: 5,
  review: "Booked a doorstep car wash through the app and the experience was smooth. The team arrived on time and cleaned the car properly inside and out.",
  service: "Car Wash",
  avatar: "RS",
},
{
  ...
  location: "Mumbai",
  rating: 5,
  review: "Laundry service was quick and convenient. Pickup was on time and the clothes were delivered neatly packed the next day.",
  service: "Laundry",
  avatar: "FK",
},
  {
