                    ...
                    <div className="container mx-auto px-4">
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="text-muted-foreground text-lg leading-relaxed space-y-4 mt-8">
                                ...
                                <p>having its registered office at: <br />
                                    BG-60 Main NH-58 <br />
                                    Yogi Puram, Meerut – 250001, Uttar Pradesh, India <br />
                                    Email: support@withneedin.com <br />
                                    Website: <a href="http://www.withneedin.com" className="text-primary hover:underline">www.withneedin.com</a></p>
                                <p>
                                ...
                                <p>Any individual registering on and using the <strong>Needin</strong> mobile application to avail <strong>Needin Express</strong> delivery services<br />
                                (hereinafter referred to as the <strong>“User”</strong>).</p>
                                ...
                                <p>
                                    Needin Express is a <strong>technology-enabled delivery facilitation service</strong> that connects Users with <strong>independent delivery partners</strong> for travel-based, deliveries. The Company does not itself provide travel based delivery services.
                                </p>
                                ...
                                <p>
                                    The Company acts <strong>solely as a facilitator and technology platform</strong>. Delivery services are performed by <strong>independent travel-based delivery partners</strong>. Nothing in this Agreement creates an employer-employee, agency, partnership, or joint-venture relationship between the Company and any travel-based delivery partner delivery partner.
                                </p>
                                ...
                                <p>
                                    Users must be <strong>18 years of age or older</strong> and legally capable of entering into a binding contract under Indian law to use Needin Express.
                                </p>
                                ...
                                <ul className="list-disc pl-8">
                                    ...
                                    <li>Such photographs may include images of the outer packaging, seals, and visible condition of the parcel at the time of pickup. These photographs shall be treated as valid evidence of the parcel’s apparent external condition at the time of handover.</li>
                                    <li>In the event of any claim, complaint, or dispute regarding damage, leakage, or breakage of the contents, such photographic evidence shall be relied upon to determine whether the parcel was externally intact at the time of pickup. The Company shall not be held liable for damages arising from inadequate, improper, or defective packaging by the User.</li>
                                </ul>
                                ...
                                <p>
                                    The Company and delivery partners <strong>do not inspect parcel contents</strong>. The User warrants that all declarations are true and lawful and indemnifies the Company against violations.
                                </p>
                                ...
                                <p>
                                    Pickup and delivery timelines shown in the App are <strong>estimates only</strong> and <strong>not guaranteed</strong>. Delays may occur due to traffic, weather, technical issues, or other factors beyond control.
                                </p>
                                ...
                                <ul className="list-disc pl-8">
                                    <li>Delivery charges are calculated based on distance, parcel characteristics, and applicable platform fees;</li>
                                    <li>Payments must be completed successfully before a delivery request is processed;</li>
                                    <li><strong>Delivery charges are generally non-refundable,</strong> unless expressly stated or required by law.</li>
                                </ul>
                                ...
                                <ul className="list-disc pl-8">
                                    <li>Once a parcel has been picked up, <strong>cancellation is not permitted;</strong></li>
                                ...
                                <ul className="list-disc pl-8">
                                    <li>The Company shall <strong>not be liable</strong> for loss, damage, theft, delay, or non-delivery of parcels;</li>
                                    <li>The Company shall not be liable for indirect, incidental, or consequential damages.</li>
                                </ul>
                                ...
                                <p>
                                    User data shall be collected and processed in accordance with the Company’s <Link to="/Privacy" className="text-primary hover:underline"><strong>Privacy Policy</strong></Link>.
                                </p>
                                ...
                                <p>
                                    This Agreement shall be governed by the laws of India. Courts at <strong>Meerut, Uttar Pradesh</strong> shall have exclusive jurisdiction.
                                </p>
                                ...
                                <ul className="list-disc pl-8">
                                    ...
                                    <li>Carrying the parcel will not require any additional travel, special route, or separate trip;</li>
                                    <li>Needin Express only provides a travel-based parcel connection facility and does not require or compel any Delivery Partner to undertake an additional journey.</li>
                                </ul>
                                <p>
                                ...
                                <p>
                                    By creating a profile or continuing to use the Needin App, the User confirms that they have read, understood, and accepted this Agreement along with the <Link to="/Terms" className="text-primary hover:underline"><strong>Terms & Conditions</strong></Link> and <Link to="/Privacy" className="text-primary hover:underline"><strong>Privacy Policy</strong></Link> of the Company.
                                </p>
                            </div>
